...
const ja: Dict = {
  ...
  "nav.drafts": "下書き",
  "nav.todo": "TODO",
  "nav.todo.title": "TODO（後で対応するメール）",
  "todo.intro":
    "TODO に印を付けたメールの一覧。期限を付けると受信箱でリマインドします（端末内のみ・相手には出ません）。",
  "todo.empty":
    "TODO はありません。メールを開いて「TODO に追加」を押すと、ここに貯まります。",
  ...
  // OpenProject 連携
  "op.title": "OpenProject 連携",
  "op.intro":
    "TODO やメールを OpenProject の work package として起票します。接続情報は端末内のみ（APIキーは外に出ません）。",
  "op.connected": "接続済み",
  "op.baseUrl": "インスタンス URL",
  "op.apiKey": "API キー",
  "op.apiKey.note":
    "OpenProject の「アカウント設定 → アクセストークン」で API トークンを発行して貼り付けてください。",
  "op.connect.btn": "接続してプロジェクト取得",
  "op.connect.ok": "接続できました（プロジェクト {n} 件）。",
  "op.connect.fail": "接続に失敗しました。",
  "op.project": "既定の送り先プロジェクト",
  "op.save": "保存",
  "op.saved": "保存しました。",
  "op.disconnect": "接続を解除",
  "op.disconnected": "接続を解除しました。",
  "op.sending": "OpenProject に送信中…",
  "op.sent": "OpenProject に起票しました。",
  "op.sendTodo": "OpenProject に起票",
  "op.sendMail": "OpenProject に起票",
  "op.open": "OpenProject を開く",
  "op.desc.from": "差出人",
  "op.desc.date": "受信日時",
  "op.desc.footer": "Asanagi（朝凪）から起票",
  "drafts.empty":
  ...
  "threat.markSafe": "問題無し",
  "threat.reportSpam": "スパムに分類",
...
const en: Dict = {
  ...
  "nav.drafts": "Drafts",
  "nav.todo": "TODO",
  "nav.todo.title": "TODO (mail to handle later)",
  "todo.intro":
    "Emails you flagged as TODO. Set a due date and the inbox reminds you (on-device only; nothing is sent to anyone).",
  "todo.empty":
    "No TODOs yet. Open a mail and press ‘Add to TODO’ to add it here.",
  "todo.openCount": "{n} open",
  "todo.due": "Due",
  "todo.done": "Done",
  "todo.remove": "Remove from TODO",
  "todo.add": "Add to TODO",
  "todo.overdueBanner": "⏰ {n} overdue TODO(s) — review",
  // OpenProject integration
  "op.title": "OpenProject integration",
  "op.intro":
    "Turn a TODO or email into an OpenProject work package. Connection details stay on this device (the API key never leaves).",
  "op.connected": "Connected",
  "op.baseUrl": "Instance URL",
  "op.apiKey": "API key",
  "op.apiKey.note":
    "Create an API token under OpenProject's Account settings → Access tokens and paste it here.",
  "op.connect.btn": "Connect & load projects",
  "op.connect.ok": "Connected ({n} projects).",
  "op.connect.fail": "Connection failed.",
  "op.project": "Default target project",
  "op.save": "Save",
  "op.saved": "Saved.",
  "op.disconnect": "Disconnect",
  "op.disconnected": "Disconnected.",
  "op.sending": "Sending to OpenProject…",
  "op.sent": "Created in OpenProject.",
  "op.sendTodo": "Create in OpenProject",
  "op.sendMail": "Create in OpenProject",
  "op.open": "Open in OpenProject",
  "op.desc.from": "From",
  "op.desc.date": "Received",
  "op.desc.footer": "Created from Asanagi",
  ...
  "list.zoom.in": "Enlarge list",
  "list.zoom.out": "Shrink list",
  "list.zoom.reset": "Reset zoom",
  ...
  "threat.markSafe": "Not spam",
  "threat.reportSpam": "Mark as spam",
...
const fr: Dict = {
  ...
  "nav.todo": "TODO",
  "nav.todo.title": "TODO (e-mails à traiter plus tard)",
  "todo.intro":
    "E-mails marqués comme TODO. Ajoutez une échéance et la boîte de réception vous le rappelle (sur l'appareil uniquement).",
  "todo.empty":
  ...
  "todo.add": "Ajouter au TODO",
  "todo.overdueBanner": "⏰ {n} TODO en retard — vérifier",
  // Intégration OpenProject
  "op.title": "Intégration OpenProject",
  "op.intro":
    "Transformez un TODO ou un e-mail en work package OpenProject. Les informations de connexion restent sur cet appareil (la clé API ne sort jamais).",
  "op.connected": "Connecté",
  "op.baseUrl": "URL de l'instance",
  "op.apiKey": "Clé API",
  "op.apiKey.note":
    "Créez un jeton d'accès dans OpenProject (Paramètres du compte → Jetons d'accès) et collez-le ici.",
  "op.connect.btn": "Se connecter et charger les projets",
  "op.connect.ok": "Connecté ({n} projets).",
  "op.connect.fail": "Échec de la connexion.",
  "op.project": "Projet cible par défaut",
  "op.save": "Enregistrer",
  "op.saved": "Enregistré.",
  "op.disconnect": "Déconnecter",
  "op.disconnected": "Déconnecté.",
  "op.sending": "Envoi vers OpenProject…",
  "op.sent": "Créé dans OpenProject.",
  "op.sendTodo": "Créer dans OpenProject",
  "op.sendMail": "Créer dans OpenProject",
  "op.open": "Ouvrir dans OpenProject",
  "op.desc.from": "Expéditeur",
  "op.desc.date": "Reçu",
  "op.desc.footer": "Créé depuis Asanagi",
  "drafts.empty":
  ...
  "list.zoom.in": "Agrandir la liste",
  "list.zoom.out": "Réduire la liste",
  "list.zoom.reset": "Réinitialiser le zoom",
  ...
  "threat.markSafe": "Pas indésirable",
  "threat.reportSpam": "Classer indésirable",
...
const zh: Dict = {
  ...
  "nav.drafts": "草稿",
  "nav.todo": "TODO",
  "nav.todo.title": "TODO（稍后处理的邮件）",
  "todo.intro":
    "标记为 TODO 的邮件清单。设置期限后，收件箱会提醒你（仅在本机，不发送给任何人）。",
  "todo.empty": "暂无 TODO。打开邮件并点击「加入 TODO」即可加入这里。",
  "todo.openCount": "未完成 {n} 项",
  "todo.due": "期限",
  "todo.done": "完成",
  "todo.remove": "从 TODO 移除",
  "todo.add": "加入 TODO",
  "todo.overdueBanner": "⏰ 有 {n} 项已过期的 TODO — 查看",
  // OpenProject 集成
  "op.title": "OpenProject 集成",
  "op.intro":
    "将 TODO 或邮件登记为 OpenProject 的 work package。连接信息仅保存在本机（API 密钥不会外泄）。",
  "op.connected": "已连接",
  "op.baseUrl": "实例 URL",
  "op.apiKey": "API 密钥",
  "op.apiKey.note":
    "请在 OpenProject 的「账户设置 → 访问令牌」中生成 API 令牌并粘贴到此处。",
  "op.connect.btn": "连接并获取项目",
  "op.connect.ok": "已连接（{n} 个项目）。",
  "op.connect.fail": "连接失败。",
  "op.project": "默认目标项目",
  "op.save": "保存",
  "op.saved": "已保存。",
  "op.disconnect": "断开连接",
  "op.disconnected": "已断开连接。",
  "op.sending": "正在发送到 OpenProject…",
  "op.sent": "已在 OpenProject 中创建。",
  "op.sendTodo": "在 OpenProject 中创建",
  "op.sendMail": "在 OpenProject 中创建",
  "op.open": "在 OpenProject 中打开",
  "op.desc.from": "发件人",
  "op.desc.date": "接收时间",
  "op.desc.footer": "由 Asanagi 创建",
